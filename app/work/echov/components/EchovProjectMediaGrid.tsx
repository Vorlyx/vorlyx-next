...
interface EchovProjectMediaGridProps {
  gridItems: GridItem[];
}
...
/**
 * Echov Project Media Grid component
 * 10-cube grid with flexible object positioning
 * Background: Light Gray (#EDEDED)
 */
export default function EchovProjectMediaGrid({
  gridItems,
}: EchovProjectMediaGridProps) {
